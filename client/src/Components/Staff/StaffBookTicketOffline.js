...
function StaffBookTicketOffline() {
  ...
  const redirect = (id) => {
    navigate(
      `/staff-book-ticket-seat/${uId}/${movieId}/${id}/${movieDate}/${data.screenId._id}`
    );
  };
            ...
            <div className="card user-book-ticket-card">
              ...
              <div className="card-body d-flex user-book-ticket-cardbody">
                ...
                {filteredShowTimes.map((show, index) => {
                  ...
                  const isBookingClosed = timeDiffInMinutes <= 0;
...
export default StaffBookTicketOffline;
