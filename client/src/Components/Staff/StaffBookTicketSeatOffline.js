...
function StaffBookTicketSeatOffline() {
  ...
  const redirect = (id) => {
    navigate(
      `/staff-book-ticket-select-seat/${uId}/${movieId}/${showId}/${selectedSeat}/${movieDate}/${sId}`
    );
  };
...
export default StaffBookTicketSeatOffline
