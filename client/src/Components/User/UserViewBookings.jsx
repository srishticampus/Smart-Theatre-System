...
function UserViewBookings() {
  ...
  data.map((details) => {
    ...
    const [hours, minutes] = details.showId.startTime.split(":").map(Number);
          ...
          <div className="col-lg-5 col-md-4 col-sm-12">
            <div className="user_view_bookings_card">
              ...
              <p className="user_view_bookings_time">
                ...
                {details.movieDate.slice(8, 10)} {getMonthName(details.movieDate)},{" "}
            ...
            <div className="user_view_bookings_card">
              ...
              <div className="d-flex justify-content-between">
                {food ? (
                  ...
                  <p className="user_view_bookings_seats m-0">No food booked</p>
                )}
              </div>
              ...
              <div className="d-flex justify-content-between">
                {parking ? (
                  ...
                  <p className="user_view_bookings_seats m-0">No parking booked</p>
                )}
              </div>
            </div>
          </div>
