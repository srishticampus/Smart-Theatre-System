...
import "../../Assets/Styles/AdminEditShowTime.css"


function AdminEditShowTime() {
  ...
  return (
    <div>
<p className='admin-edit-show-head'>Edit Show Time</p>
            <div className='edit-show-time-container'>
                {/* Sunday Accordion */}
                <div className='admin-edit-showtime'>
                    {openDay !== 'Sunday' && (
                    ...
                    {openDay === 'Sunday' && (
                        <div className='card admin-edit-showcard p-3'>
                            <div>
                                <p>Sunday</p>
                            </div>
                            ...
                            <div className="row d-flex align-items-center">
                                <div className="col-sm-5">
                                    <input type="time" value="09:00" className='admin-edit-showtime-space' />
                                </div>
                                <div className="col-sm-2 text-center">
                                    <span className='mt-3'>to</span>
                                </div>
                                <div className="col-sm-5 text-end">
                                    <input type="time" value="12:30" className='admin-edit-showtime-space' />
                                </div>
                            </div>
                            <div className="row d-flex align-items-center">
                                <div className="col-sm-5">
                                    <input type="time" value="01:00" className='admin-edit-showtime-space' />
                                </div>
                                <div className="col-sm-2 text-center">
                                    <span className='mt-3'>to</span>
                                </div>
                                <div className="col-sm-5 text-end">
                                    <input type="time" value="04:30" className='admin-edit-showtime-space' />
                                </div>
                            </div>
                            <div className="row d-flex align-items-center">
                                <div className="col-sm-5">
                                    <input type="time" value="06:00" className='admin-edit-showtime-space' />
                                </div>
                                <div className="col-sm-2 text-center">
                                    <span className='mt-3'>to</span>
                                </div>
                                <div className="col-sm-5 text-end">
                                    <input type="time" value="09:30" className='admin-edit-showtime-space' />
                                </div>
                            </div>
                            <div className="row d-flex align-items-center">
                                <div className="col-sm-5">
                                    <input type="time" value="10:00" className='admin-edit-showtime-space' />
                                </div>
                                <div className="col-sm-2 text-center">
                                    <span className='mt-3'>to</span>
                                </div>
                                <div className="col-sm-5 text-end">
                                    <input type="time" value="01:30" className='admin-edit-showtime-space' />
                                </div>
...
export default AdminEditShowTime
